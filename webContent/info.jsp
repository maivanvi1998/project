			...
			<div class="container dark-grey-text mt-5">
				...
				<div class="row wow fadeIn">
					...
					<div class="col-md-6 mb-4">
						...
						<img src="${info.src}" class="img-fluid" alt="">
					...
					<div class="col-md-6 mb-4">
						...
						<div class="p-4">
							<p class="lead">
								<h4 style="color: navy;">${info.name}</h4>
								</span> <span style="color: red;">${info.price}$</span>
							</p>
							...
							<form method="post" class="d-flex justify-content-left" action="AddToCartController?id=${info.id}&action=add">
								<!-- Default input -->
